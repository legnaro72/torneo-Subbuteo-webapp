...
class GazzettaPDF(FPDF):
    ...
    def header(self):
        ...
        # 🛡️ Logo "Superba" a sinistra (se disponibile)
...
def render_app_title():
    ...
    st.markdown(f"""
        <style>
        div[data-testid="stElementContainer"]:has(div.st-key-superba_banner_audio_button),
        div.element-container:has(div.st-key-superba_banner_audio_button) {{
            display: flex !important;
            justify-content: center !important;
        ...
        div.st-key-superba_banner_audio_button {{
            display: flex !important;
            justify-content: center !important;
            position: relative;
            width: 100% !important;
        ...
        div.st-key-superba_banner_audio_button button {{
            position: relative;
        ...
        div.st-key-superba_banner_audio_button button:hover {{
            transform: translateY(-1px) scale(1.05);
            filter: brightness(1.06);
        }}
        div.st-key-superba_banner_audio_button button:active {{
            transform: translateY(0) scale(0.98);
        }}
        div.st-key-superba_banner_audio_button label {{
            display: flex !important;
            align-items: center !important;
            gap: 4px !important;
        ...
        div.st-key-superba_banner_audio_button label p {{
        ...
        div.st-key-superba_banner_audio_button [data-baseweb="checkbox"] {{
    ...
    if st.button(audio_label, key="superba_banner_audio_button", help=audio_help):
...
def main():
    ...
    st.sidebar.markdown(
        f'''
        <a href="{escape(HUB_URL, quote=True)}"
           style="
               display:flex;
               align-items:center;
