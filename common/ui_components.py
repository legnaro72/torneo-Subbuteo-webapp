...
def force_sidebar_collapsed_on_startup():
    """
    Forza la sidebar chiusa a fine render.

    Streamlit rispetta initial_sidebar_state solo al mount iniziale; su mobile,
    dopo auth/rerun/componenti, la sidebar puo restare aperta. Questo script gira
    come ultima operazione visiva e richiude solo se la sidebar risulta aperta.
    """
    import streamlit.components.v1 as components
    ...
    components.html(
        ...
        (function () {
          ...
          [0, 150, 350, 700, 1200, 2000, 3200].forEach(function (delay) {
