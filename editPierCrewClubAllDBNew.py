...
class GazzettaClubPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 10, "IL GAZZETTINO DEL PIER CREW", border=0, new_x="LMARGIN", new_y="NEXT", align='L')
        # Sottotitolo
        self.set_x(start_x)
        self.set_font("helvetica", 'I', 11)
        self.set_text_color(220, 225, 235)
        data_stampa = datetime.now().strftime("%d/%m/%Y alle %H:%M")
        self.cell(0, 6, f"Composizione Club PierCrew | Aggiornato il {data_stampa}", border=0, new_x="LMARGIN", new_y="NEXT", align='L')
        self.ln(12)
