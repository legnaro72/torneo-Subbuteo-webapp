...
function App() {
  ...
  if (!ready) return <div className="loading"><img className="brand-logo" src="/logo-superba.jpg" alt="Logo Superba"/><p>Benvenuto in Superba…</p></div>;
