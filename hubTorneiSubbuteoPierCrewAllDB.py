...
with col1:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link" href="https://torneo-subbuteo-piercrew-ita-all-db.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
...
with col2:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link" href="https://torneo-subbuteo-FF-piercrew-ita-all-db.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
...
with col4:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link card-link-red" https://edit-piercrew-club-all-db.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
