...
URL_CAMPIONATO = auth.make_authenticated_url("https://torneo-subbuteo-superba-ita-all-db.streamlit.app/")
URL_FASI_FINALI = auth.make_authenticated_url("https://torneo-subbuteo-FF-superba-ita-all-db.streamlit.app/")
URL_SVIZZERO = auth.make_authenticated_url("https://torneo-subbuteo-superba-new-version-svizzero-alldb.streamlit.app/")
URL_CLUB = auth.make_authenticated_url("https://edit-superba-club-all-db-new.streamlit.app/")
