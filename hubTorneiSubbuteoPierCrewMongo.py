...
with col1:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link" href="https://torneosubbuteopiercrewmongo.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
...
with col3:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link" href="https://torneosvizzeropiercrewbylegnaro72mongo.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
...
with col4:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link card-link-red" href="https://editpiercrewmongo.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
