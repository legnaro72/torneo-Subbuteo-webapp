...
URL_CAMPIONATO = auth.make_authenticated_url("https://torneo-subbuteo-tigullio-ita-all-db.streamlit.app/")
URL_FASI_FINALI = auth.make_authenticated_url("https://torneo-subbuteo-FF-tigullio-ita-all-db.streamlit.app/")
URL_SVIZZERO = auth.make_authenticated_url("https://torneo-subbuteo-tigullio-new-version-svizzero-alldb.streamlit.app/")
URL_CLUB = auth.make_authenticated_url("https://edit-tigullio-club-all-db-new.streamlit.app/")
