    ...
    st.markdown('''
        <div class="card" style="height: 100%;">
            ...
            <div style="display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
                <a class="card-link" href="https://torneo-subbuteo-tigullio-new-version-svizzero-alldb.streamlit.app/" target="_blank">
                    <span style="margin-right:8px;">▶</span> Avvia Modalità
                </a>
            </div>
        </div>
...
with col4:
    st.markdown('''
        <div class="card" style="height: 100%; border: 1px solid rgba(230,57,70,0.3);">
            ...
            <br>
            <a class="card-link card-link-red" href="https://edit-tigullio-club-all-db-new.streamlit.app/" target="_blank" style="width: 80%;">
