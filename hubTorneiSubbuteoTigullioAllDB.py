...
with col1:
    st.image("logo_tigullio.jpg", width=100)
with col2:
...
with col1:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link" href="https://torneo-subbuteo-tigullio-ita-all-db.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
...
with col2:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link" href="https://torneo-subbuteo-FF-tigullio-ita-all-db.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
    ...
    st.markdown('''
        <div class="card">
            ...
            <div class="card-link-container">
                <a class="card-link" href="https://torneo-subbuteo-tigullio-new-version-svizzero-alldb.streamlit.app/" target="_blank">Apri App</a>
                #<a class="card-link card-link-beta" href="https://torneo-subbuteo-tigullio-new-version-svizzero-alldb.streamlit.app/" target="_blank">Apri App Beta ++</a>
            </div>
        </div>
    ''', unsafe_allow_html=True)
...
with col4:
    st.markdown('''
        <div class="card">
            ...
            <a class="card-link card-link-red" href="https://edit-tigullio-club-all-db.streamlit.app/" target="_blank">Apri App</a>
        </div>
    ''', unsafe_allow_html=True)
