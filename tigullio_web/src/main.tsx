...
function App() {
  ...
  if (!ready) return <div className="loading"><img className="brand-logo" src="/logo-tigullio.jpg" alt="Logo Tigullio"/><p>Benvenuto in Tigullio…</p></div>;
