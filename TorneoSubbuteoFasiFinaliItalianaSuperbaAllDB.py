        ...
        if tipo_vista == 'compact':
            ...
            with casa_col:
                st.markdown(
                    ...
                    f"<div class='superba-compact-team-name home'>{escape(str(label_a))}</div>",
                    unsafe_allow_html=True
                )
            with gol_casa_col:
    ...
    if st.session_state['ui_show_pre']:
        ...
        if opzione_selezione == "Creare una nuova fase finale":
                ...
                if not tornei_trovati:
                    ...
                    st.link_button("🏠 Vai alla gestione tornei", "https://farm-tornei-subbuteo-superba-all-db.streamlit.app/", width="stretch")
                    return
                else:
                    tornei_opzioni = {}
                    for torneo in tornei_trovati:
