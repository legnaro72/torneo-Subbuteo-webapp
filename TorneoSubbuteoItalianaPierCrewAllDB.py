...
def inject_parent_head_assets(is_campionato: bool):
    ...
    components.html(
        ...
        try {{
          ...
          const iconHref = "/app/static/logo_piercrew.jpg";
...
HOME_URL = "https://torneo-subbuteo-piercrew-ita-all-db.streamlit.app/"
...
def inject_top_gap_css():
    st.html("""
        ...
        div[data-testid="stElementContainer"].st-key-subbuteo_piercrew_cookie_manager,
        div.st-key-subbuteo_piercrew_cookie_manager,
        ...
        div.st-key-subbuteo_piercrew_cookie_manager iframe {
            display: none !important;
            height: 0 !important;
            min-height: 0 !important;
        }
                ...
                if st.session_state.get('azione_scelta') in (None, 'carica'):           
                    with st.container(border=True):
                        ...
                        if tornei_disponibili:
                            ...
                            torneo_preferito = "CampionatoPierCrew_26_27"
